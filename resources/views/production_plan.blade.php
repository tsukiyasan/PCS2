            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">計劃編號</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($plans as $row)
                        <tr class="hover:bg-blue-50 transition duration-150 group">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 font-mono">{{ $row->keikaku_no }}</td>
